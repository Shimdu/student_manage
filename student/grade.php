            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="ec-archive2"></i>成绩查询</h1>
                        <!-- Start .bredcrumb -->
